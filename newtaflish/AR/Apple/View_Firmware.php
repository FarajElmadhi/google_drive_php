...
<meta name="description" content="تحميل فيرموير <?php echo $row['Model_Name']; ?> ,<?php echo $row['Model']; ?>,<?php echo $row['Identifier']; ?> أحدث الاصدارات  ">
...
<title>فيرموير <?php echo $row['Model_Name']; ?> <?php echo $row['Model']; ?> <?php echo $row['Identifier']; ?> </title>
...
></span></a>
            <ul class=" dropdown-menu text-right" >
              ...
              <li><a class="text-right" href="../../EN/Apple/View_Firmware.php?Model=<?php echo $row['Model']; ?>">English</a></li>
            </ul>
          </li>
    ...
    <div class="row">
      <div class="col-xs-12 visible-xs">
        <div class="all-device-mobile">
          <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" ><?php echo $row['Model_Name']; ?> (<?php echo $row['Model']; ?>) الفيرمويرات المتوفرة لهاتف    </h4></div>
   <?php  foreach($roms as $row){ ?>

       <div class="mobile-table btn-block text-center "> <a href="Download_Firmware.php?ifid=<?php echo $row['ifid']; ?>"> <div class="file-type ">فيرموير<p><pr> <span class="glyphicon glyphicon glyphicon-eye-open"></span> <?php echo $row['view']; ?></p></div> <?php echo $row['Model_Name']; ?> -  <?php echo $row['Model']; ?>  - <?php echo $row['Identifier']; ?>  -   ( <?php echo $row['Version']; ?> ) </a></div>
                          <?php }     ?>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12  hidden-xs">
          <div class="main-table">
            <div class="all-device ">
              <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" ><?php echo $row['Model_Name']; ?> (<?php echo $row['Model']; ?>) الفيرمويرا المتوفرة لهاتف  </h4></div>
              ...
              <tbody>
                ...
                <?php  foreach($roms as $row){ ?>
                  <tr>
                    ...
                    <td><a class="link-main" href="Download_Firmware.php?ifid=<?php echo $row['ifid']; ?>" > تحميل <span class="fa fa-chevron-right"> </span></a></td>
                  </tr>
                  <?php }   ?>
              </tbody>
            </table>
