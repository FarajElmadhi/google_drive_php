...
$stmt = $connect->prepare(" SELECT * FROM `nokiaflashes` WHERE `nfid` = ?");
...
$view = $row['view'] +1;
$stmt = $connect->prepare("UPDATE `nokiaflashes` SET view= ?  WHERE `nfid` = ?");
...
<meta name="description" content="تحميل فلاشة  <?php echo $row['Companny']; ?> <?php echo $row['Model_Name']; ?> موديل  :  <?php echo $row['Model']; ?> اصدار <?php echo $row['Version']; ?>">
...
<title>تحميل فلاشة <?php echo $row['Companny']; ?> موديل : <?php echo $row['Model']; ?> اصدار : <?php echo $row['Version']; ?></title>
...
></span></a>
            <ul class=" dropdown-menu text-right" >
              ...
              <li><a class="text-right" href="../../EN/Nokia/Download_Flashes.php?nfid=<?php echo $row['nfid']; ?>">English</a></li>
            </ul>
          </li>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12  col-xs-12">
          ...
          <div class="col-lg-8 col-md-8 col-sm-8  col-xs-12">
            <div class="all-device">
              <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" ><?php echo $row['Companny']; ?>  <?php echo $row['Model']; ?> تحميل الفلاشة الرسمية لهاتف  </h4>
            </div>
            <div class="info-device" dir="rtl"> <br>
              <li>
                <h4> <p class="type"> <span class="glyphicon glyphicon-hand-left"> </span>  نوع الملف : </p>  فلاشة رسمية .</h4>
              </li>
              <br>
              <li>
