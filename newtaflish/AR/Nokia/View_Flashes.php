...
$stmt = $connect->prepare(" SELECT * FROM `nokiaflashes` WHERE Model = ?");
...
<meta name="description" content="تحميل فلاشات  <?php echo $row['Companny']; ?> <?php echo $row['Model_Name']; ?> <?php echo $row['Model']; ?>  جميع الاصدارات">
<meta name="keywords" content="فلاشة <?php echo $row['Model']; ?>, فلاشة <?php echo $row['Model_Name']; ?>,فلاشة عربية احدث اصار <?php echo $row['Model']; ?>, فلاشة عربية احدث اصدار <?php echo $row['Model_Name']; ?>, تعريب <?php echo $row['Model']; ?>, تعريب <?php echo $row['Model_Name']; ?>, تتريك <?php echo $row['Companny']; ?>,تقييد نوكيا,تتريك نوكيا, nokia imei null,repaire imei nokia,اصلاح ايمي نوكيا,جمركة نوكيا">
<title> فلاشات <?php echo $row['Companny']; ?> <?php echo $row['Model_Name']; ?> موديل : <?php echo $row['Model']; ?> </title>
...
></span></a>
            <ul class=" dropdown-menu text-right" >
              ...
              <li><a class="text-right" href="../../EN/Nokia/View_Flashes.php?Model=<?php echo $row['Model']; ?>">English</a></li>
            </ul>
          </li>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="dropdown active"  dir="rtl"> <a href="#" class="dropdown-toggle text-right" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">نوكيا<span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li><a class="text-right " href="Flashes.php"  >فلاشات نوكيا</a></li>
            </ul>
          </li>
    ...
    <div class="row">
      <div class="col-xs-12 visible-xs">
        <div class="all-device-mobile">
          <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" ><?php echo $row['Companny']; ?>  <?php echo $row['Model']; ?> الفلاشات الرسمية المتوفرة للهاتف  </h4>
        </div>
   <?php  foreach($roms as $row){ ?>

       <div class="mobile-table btn-block text-center "> <a href="Download_Flashes.php?nfid=<?php echo $row['nfid']; ?>">  <div class="file-type ">فلاشة نوكيا<p><pr> <span class="glyphicon glyphicon glyphicon-eye-open"></span> <?php echo $row['view']; ?></p></div> <?php echo $row['Model_Name']; ?>  - <?php echo $row['Model']; ?>  -    V( <?php echo $row['Version']; ?> ) </a></div>
                          <?php }     ?>
              ...
              <tbody>
                ...
                <?php  foreach($roms as $row){ ?>
                  <tr>
                    ...
                    <td><h4><?php echo $row['Companny']; ?>  ( فلاشة رسمية ) </h4></td>
                    <td><h4><?php echo $row['Model_Name']; ?></h4></td>
                    <td><h4><?php echo $row['Model']; ?></h4></td>
                     <td><h4><?php echo $row['Version']; ?></h4></td>

                    <td><a class="link-main" href="Download_Flashes.php?nfid=<?php echo $row['nfid']; ?>" > تحميل <span class="fa fa-chevron-right"> </span></a></td>
                  </tr>
                  <?php }   ?>
              </tbody>
            </table>
