...
$stmt = $connect->prepare(" SELECT * FROM cert_device ORDER BY keyid ASC");
$stmt->execute();
$roms = $stmt->fetchAll();
...
<meta name="description" content="تحميل جميع ملفات السيرت لهواتف سامسونج مجاناً">
<meta name="keywords" content="سيرت سامسونج,سيرتات سامسونج,اصلاح ايمي سامسونج,حل مشكلة imei null سامسونج,تحميل سيرتات مجانية,برنامج توليد سرتات,برنامج صناعة السيرتات,موقع بيع سيرتات,سيرتات نظيفة,سيرتات جديدة,سرت مكفول,سرت,دائم,موقع تحميل سرت,حل مشكلة فقدان الايمي,حل مشكلة مكالمات الطوارئ,حل مشكلة عدم الاتصال,حل مشكلة لاتوجد شبكة">
<title>تحميل ملفات سيرت  مجاناً  </title>
...
></span></a>
            <ul class=" dropdown-menu text-right" >
              ...
              <li><a class="text-right" href="../../EN/Samsung/Cert-Samsung.php">English</a></li>
            </ul>
          </li>
    ...
    <div class="row">
      <div class="col-xs-12 visible-xs">
        <div class="all-device-mobile">
          <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" >تحميل ملفات سيرت سامسونج</h4>
        </div>
        <?php  foreach($roms as $row){ ?>
          <div class="mobile-table btn-block text-center "> <a href="View-Cert-Samsung.php?model=<?php echo $row['model']; ?>"> <div class="file-type ">سيرت<p><pr> <span class="glyphicon glyphicon glyphicon-eye-open"></span> <?php echo $row['view']; ?></p></div> <?php echo $row['model_name']; ?> - <?php echo $row['model']; ?> - <?php echo $row['keyid']; ?> </a></div>
          <?php }   ?>
      </div>
    </div>
    <div>
              ...
              <tbody>
                <?php  foreach($roms as $row){ ?>
                  <tr>
                    ...
                    <td><h4><?php echo $row['company']; ?>  ( ملف سيرت ) </h4></td>
                    <td><h4><?php echo $row['model_name']; ?></h4></td>
                    <td><h4><?php echo $row['model']; ?></h4></td>
                    <td><h4><?php echo $row['keyid']; ?></h4></td>

                    <td><a class="link-main" href="View-Cert-Samsung.php?model=<?php echo $row['model']; ?>" > عرض <span class="fa fa-chevron-right"> </span></a></td>
                  </tr>
                  <?php }    ?>
              </tbody>
            </table>
