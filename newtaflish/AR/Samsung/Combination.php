...
<meta name="description" content="تحميل رومات الكومبينيشن لجميع موديلات هواتف سامسونج بجميع الحمايات">
...
<title>رومات كومبينيشن سامسونج</title>
...
></span></a>
            <ul class=" dropdown-menu text-right" >
              ...
              <li><a class="text-right" href="../../EN/Samsung/Combination.php">English</a></li>
            </ul>
          </li>
    ...
    <div class="row">
      <div class="col-xs-12 visible-xs">
        <div class="all-device-mobile">
          <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" >رومات كومبينيشن سامسونج</h4>
        </div>
        <?php  foreach($roms as $row){ ?>
          <div class="mobile-table btn-block text-center "> <a href="Combination_View.php?Model=<?php echo $row['Model']; ?>">  <div class="file-type ">كومبينيشن <p><pr> <span class="glyphicon glyphicon glyphicon-eye-open"></span> <?php echo $row['view']; ?></p></div> <?php echo $row['Model_Name']; ?> - <?php echo $row['Model']; ?> </a></div>
          <?php }   ?>
      </div>
    </div>
    <div>
              ...
              <tbody>
                <?php  foreach($roms as $row){ ?>
                  <tr>
                    ...
                    <td><a class="link-main" href="Combination_View.php?Model=<?php echo $row['Model']; ?>" >عرض <span class="fa fa-chevron-right"> </span></a></td>
                  </tr>
                  <?php }    ?>
              </tbody>
            </table>
