...
<meta name="description" content="تحميل روم كومبينيشن  <?php echo $row['Model_Name']; ?> <?php echo $row['Model']; ?> لجميع الحمايات">
<meta name="keywords" content="كومبينيشن <?php echo $row['Model']; ?>,ركفري معدل <?php echo $row['Model']; ?>,root <?php echo $row['Model']; ?>,root <?php echo $row['Model_Name']; ?>,recovery <?php echo $row['Model']; ?>,twrp <?php echo $row['Model']; ?>,combination rom <?php echo $row['Model']; ?>,philz <?php echo $row['Model']; ?>,unofficial recovery <?php echo $row['Model']; ?>,تتريك <?php echo $row['Model']; ?>,جمركة <?php echo $row['Model']; ?>,تقييد <?php echo $row['Model']; ?>,رووت <?php echo $row['Model']; ?>,روت بدون كمبيوتر <?php echo $row['Model']; ?>,كومبينيشن النهائي <?php echo $row['Model']; ?>, كومبينيشن خالي من المشاكل <?php echo $row['Model']; ?>,روت مجرب  <?php echo $row['Model']; ?>,final root <?php echo $row['Model']; ?>,repaire imei <?php echo $row['Model']; ?>,null imei <?php echo $row['Model']; ?> ">
<title>روم كومبينيشن <?php echo $row['Model_Name']; ?> <?php echo $row['Model']; ?> </title>
...
></span></a>
            <ul class=" dropdown-menu text-right" >
              ...
              <li><a class="text-right" href="../../EN/Samsung/Combination_View.php?Model=<?php echo $row['Model']; ?>">English</a></li>
            </ul>
          </li>
    ...
    <div class="row">
      <div class="col-xs-12 visible-xs">
        <div class="all-device-mobile">
          <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" ><?php echo $row['Model_Name']; ?> - <?php echo $row['Model']; ?>  رومات الكومبينيشن المتوفرة لهاتف </h4>
        </div>
   <?php  foreach($roms as $row){ ?>

       <div class="mobile-table btn-block text-center "> <a href="Download_Combination.php?Cid=<?php echo $row['Cid']; ?>">  <div class="file-type ">كومبينيشن<p><pr> <span class="glyphicon glyphicon glyphicon-eye-open"></span> <?php echo $row['view']; ?></p></div>  <?php echo $row['Model_Name']; ?>  - <?php echo $row['Model']; ?> - <?php echo $row['Besband']; ?>     </a></div>
                          <?php }     ?>
              ...
              <tbody>
                ...
                <?php  foreach($roms as $row){ ?>
                  <tr>
                    ...
                    <td><h4><?php echo $row['Companny']; ?>  ( روم كومبينيشن ) </h4></td>
                    <td><h4><?php echo $row['Model_Name']; ?></h4></td>
                    <td><h4><?php echo $row['Model']; ?></h4></td>
                    <td><h4><?php echo $row['Besband']; ?> </h4></td>

                    <td><a class="link-main" href="Download_Combination.php?Cid=<?php echo $row['Cid']; ?>" >تحميل <span class="fa fa-chevron-right"> </span></a></td>
                  </tr>
                  <?php }   ?>
              </tbody>
            </table>
