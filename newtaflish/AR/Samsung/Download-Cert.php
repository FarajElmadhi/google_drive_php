...
<meta name="description" content="تحميل سيرت   <?php echo $row['model_name']; ?> , <?php echo $row['model']; ?> key id <?php echo $row['key_id']; ?>">
...
<title>تحميل  سيرت <?php echo $row['company']; ?> <?php echo $row['model_name']; ?> <?php echo $row['model']; ?>  مجانا </title>
...
></span></a>
            <ul class=" dropdown-menu text-right" >
              ...
              <li><a class="text-right" href="../../EN/Samsung/Download-Cert.php?ceid=<?php echo $row['ceid']; ?>">English</a></li>
            </ul>
          </li>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12  col-xs-12">
          ...
          <div class="col-lg-8 col-md-8 col-sm-8  col-xs-12">
            <div class="all-device">
              <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" >  <?php echo $row['company']; ?>  <?php echo $row['model']; ?> تحميل ملف سيرت </h4>
            </div>
            <div class="info-device" dir="rtl"> <br>
              <li>
                <h4> <p class="type"> <span class="glyphicon glyphicon-hand-left"> </span>   نوع الملف : </p>  ملف سيرت .</h4>
              </li>
              <br>
              <li>
              ...
              <br>
               <li>
                <h4> <p class="type"> <span class="glyphicon glyphicon-hand-left"> </span>    KEY ID : </p> <?php echo $row['key_id']; ?> .</h4>
              </li>
              <br>
              <li>
                <h4> <p class="type"> <span class="glyphicon glyphicon-hand-left"> </span>    الايمي : </p> <?php echo $row['imei']; ?> .</h4>
              </li>
              <br>
              <li>
              ...
              ?>"><span class="glyphicon glyphicon-circle-arrow-down"> </span> تحميل <span class="glyphicon glyphicon-circle-arrow-down
"> </span></a></li>
              <br>
              <div class="ads-download">
              <?php echo $ads['ads_d2']; ?>
