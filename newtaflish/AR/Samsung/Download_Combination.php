...
<meta name="description" content="تحميل روم كومبينيشن للهاتف  <?php echo $row['Model_Name']; ?> , Model : <?php echo $row['Model']; ?> ,Bsband: <?php echo $row['Besband']; ?> ">
...
<title>تحميل كومبينيشن <?php echo $row['Model_Name']; ?>~<?php echo $row['Model']; ?>~<?php echo $row['Besband']; ?>  </title>
...
></span></a>
            <ul class=" dropdown-menu text-right" >
              ...
              <li><a class="text-right" href="../../EN/Samsung/Download_Combination.php?Cid=<?php echo $row['Cid']; ?>">English</a></li>
            </ul>
          </li>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12  col-xs-12">
          ...
          <div class="col-lg-8 col-md-8 col-sm-8  col-xs-12">
            <div class="all-device">
              <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" ><?php echo $row['Companny']; ?>  <?php echo $row['Model']; ?> تحميل كومبينيشن هاتف </h4>
            </div>
            <div class="info-device" dir="rtl"> <br>
              <li>
                <h4> <p class="type"> <span class="glyphicon glyphicon-hand-left"> </span>   نوع الملف : </p>  روم كومبينيشن .</h4>
              </li>
              <br>
              <li>
