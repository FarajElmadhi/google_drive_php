...
$stmt = $connect->prepare(" SELECT * FROM `modem` WHERE `MOid` = ?");
...
$view = $row['view'] +1;
$stmt = $connect->prepare("UPDATE `modem` SET view= ?  WHERE `MOid` = ?");
...
<meta name="description" content="تحميل مودم لهاتف <?php echo $row['Companny']; ?> <?php echo $row['Model_Name']; ?> <?php echo $row['Model']; ?> الحماية :<?php echo $row['Protect']; ?> ">
<meta name="keywords" content=" مودم <?php echo $row['Model']; ?>,مودم <?php echo $row['Model_Name']; ?>,modem <?php echo $row['Model']; ?> modem <?php echo $row['Model_Name']; ?>,حل مشكلة null imei <?php echo $row['Model']; ?>,حل مشكلة مكالمات الطوارئ <?php echo $row['Model']; ?>,حل مشبكلة شبكة <?php echo $row['Model']; ?>,reset msl <?php echo $row['Model']; ?>,write cert <?php echo $row['Model']; ?>, fix null imei <?php echo $row['Model']; ?>, repeire imei <?php echo $row['Model']; ?>">
<title>تحميل مودم <?php echo $row['Model_Name']; ?> ~ <?php echo $row['Model']; ?> ~ حماية : <?php echo $row['Protect']; ?> </title>
...
></span></a>
            <ul class=" dropdown-menu text-right" >
              ...
              <li><a class="text-right" href="../../EN/Samsung/Download_Modem.php?MOid=<?php echo $row['MOid']; ?>">English</a></li>
            </ul>
          </li>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12  col-xs-12">
          ...
          <div class="col-lg-8 col-md-8 col-sm-8  col-xs-12">
            <div class="all-device">
              <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" ><?php echo $row['Companny']; ?>  <?php echo $row['Model']; ?> تحميل مودم لهاتف  </h4>
            </div>
            <div class="info-device" dir="rtl"> <br>
              <li>
                <h4> <p class="type"> <span class="glyphicon glyphicon-hand-left"> </span>  نوع المودم  :  </p> <?php echo  $row['type']; ?> . </h4>
              </li>
              <br>
              <li>
                <h4> <p class="type"> <span class="glyphicon glyphicon-hand-left"> </span>   الشركة المصنعة : </p> SAMSUNG  .</h4>
              </li>
              <br>
              <li>
              ...
              <br>
               <li>
                <h4> <p class="type"> <span class="glyphicon glyphicon-hand-left"> </span>     <?php if($row['Besband'] == "0"){ echo "الحماية";} else { echo "البيسباند"; }?> : </p> <?php if($row['Besband'] == "0"){ echo $row['Protect'];} else { echo $row['Besband']; }?> .</h4>
              </li>
              <br>
              
              <?php if($row['Version'] != ''){  ?>
              <li>
                <h4> <p class="type"> <span class="glyphicon glyphicon-hand-right"> </span>   الاصدار  : </p> <?php echo $row['Version']; ?>  .</h4>
              </li>
              <br>
              <?php ;}?>
              ...
              <?php ;}?>
               ...
               <li>
                <h4> <p class="type"> <span class="glyphicon glyphicon-hand-left"> </span>   تاريخ الرفع : </p> <?php echo $row['date']; ?>  .</h4>
              </li>
              <br>
