...
<html lang="ar">
<head>
<title> تحميل الروم الرسمي  <?php echo $row['Model_Name']; ?> - <?php echo $row['Modell']; ?> V: <?php echo $row['Vrsion']; ?>  <?php echo $row['Besband']; ?> <?php echo $row['Languages']; ?></title>

<meta name="description" content="تحميل الروم الرسمي لهاتف سامسونج <?php echo $row['Model_Name']; ?> , موديل  : <?php echo $row['Modell']; ?> <?php echo $row['Vrsion']; ?>  <?php echo $row['Besband']; ?> <?php echo $row['Languages']; ?>">
...
></span></a>
            <ul class=" dropdown-menu text-right" >
              <li class="arabic text-right" ><a  href="Download_Rom.php?Oid=<?php echo $row['Oid']; ?>">العربية</a></li>
              <li role="separator" class="divider"></li>
              <li><a class="text-right" href="../../EN/Samsung/Download_Rom.php?Oid=<?php echo $row['Oid']; ?>">English</a></li>
            </ul>
          </li>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12  col-xs-12">
          ...
          <div class="col-lg-8 col-md-8 col-sm-8  col-xs-12">
            <div class="all-device">
              <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" > <?php echo $row['Companny']; ?> - <?php echo $row['Modell']; ?>  تحميل الروم الرسمي للهاتف</h4>
            </div>
            <div class="info-device " dir="rtl"> <br>
              ...
              <br>
              <li>
                <h4> <p class="type"> <span class="glyphicon glyphicon-hand-left"> </span>   رقم الطراز : </p> <?php echo $row['Modell']; ?> .</h4>
              </li>
              <br>
               <li>
