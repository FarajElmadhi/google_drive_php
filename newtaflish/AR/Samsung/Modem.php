...
$stmt = $connect->prepare(" SELECT * FROM modem_device ORDER BY Model ASC");
$stmt->execute();
$roms = $stmt->fetchAll();
...
<meta name="description" content="تحميل ملفات مودم لجميع موديلات السامسونج لحل مشكل imei Null ولاستعادة شبكة الاتصال">
<meta name="keywords" content=" مودم , تحميل مودم , حل مشكلة غير مسجل على الشبكة , imei null, modem samsung ">
<title>ملفات مودم سامسونج  </title>
...
></span></a>
            <ul class=" dropdown-menu text-right" >
              ...
              <li><a class="text-right" href="../../EN/Samsung/Modem.php">English</a></li>
            </ul>
          </li>
    ...
    <div class="row">
      <div class="col-xs-12 visible-xs">
        <div class="all-device-mobile">
          <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" >تحميل ملفات مودم سامسونج</h4>
        </div>
        <?php  foreach($roms as $row){ ?>
          <div class="mobile-table btn-block text-center "> <a href="View_Modem.php?Model=<?php echo $row['Model']; ?>"> <div class="file-type ">مودم<p><pr> <span class="glyphicon glyphicon glyphicon-eye-open"></span> <?php echo $row['view']; ?></p></div>
              ...
              <tbody>
                <?php  foreach($roms as $row){ ?>
                  <tr>
                    ...
                    <td><h4><?php echo $row['Companny']; ?> </h4></td>
                    <td><h4><?php echo $row['Model_Name']; ?></h4></td>
                    <td><h4><?php echo $row['Model']; ?></h4></td>
                    <td><a class="link-main" href="View_Modem.php?Model=<?php echo $row['Model']; ?>" >عرض  <span class="fa fa-chevron-right"> </span></a></td>
                  </tr>
                  <?php }    ?>
              </tbody>
            </table>
