...
<meta name="description" content="تحميل الرومات الرباعية - رومات 4 ملفات - لهواتف سامسونج جميع الاصدارات" />
<meta name="keywords" content="rom 4 files,rom repaire, رومات 4 ملفات,رومات اصلاح الهاتف,حل مشكلة الموت المفاجئ,rom facotory reset" />
<title>تحميل رومات 4 ملفات لهواتف سامسونج</title>
...
></span></a>
            <ul class=" dropdown-menu text-right" >
              ...
              <li><a class="text-right" href="../../EN/Samsung/Rom4_Samsung.php">English</a></li>
            </ul>
          </li>
    ...
    <div class="row">
      <div class="col-xs-12 visible-xs">
        <div class="all-device-mobile">
          <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" > رومات سامسونج 4 ملفات </h4>
        </div>
        <?php  foreach($roms as $row){ ?>
          <div class="mobile-table btn-block text-center "> <a href="View_Rom4.php?Model=<?php echo $row['Model']; ?>"> <div class="file-type ">روم 4 ملفات<p><pr> <span class="glyphicon glyphicon glyphicon-eye-open"></span> <?php echo $row['view']; ?></p></div> <?php echo $row['Model_Name']; ?> - <?php echo $row['Model']; ?> </a></div>
          <?php }   ?>
      </div>
    </div>
    <div>
              ...
              <tbody>
                <?php  foreach($roms as $row){ ?>
                  <tr>
                    ...
                    <td><a class="link-main" href="View_Rom4.php?Model=<?php echo $row['Model']; ?>" >عرض<span class="fa fa-chevron-right"> </span></a></td>
                  </tr>
                  <?php }    ?>
              </tbody>
            </table>
