...
<meta name="description" content="تحميل سيرتات   <?php echo $row['model_name']; ?> , <?php echo $row['model']; ?> key id <?php echo $row['key_id']; ?>">
<meta name="keywords" content=" سيرت <?php echo $row['model_name']; ?>, سيرتات <?php echo $row['model']; ?>, اصلاح ايمي <?php echo $row['model']; ?>, سرت نظيف <?php echo $row['model']; ?>, اصلاح ايمي نيول <?php echo $row['model']; ?>,تغيير ايمي<?php echo $row['model']; ?>,سيرت يعمل <?php echo $row['model']; ?>,تتريك <?php echo $row['model_name']; ?>,جمركة <?php echo $row['model']; ?>,تبديل ايمي <?php echo $row['model']; ?>,سيرت يعمل في سوريا<?php echo $row['model_name']; ?>,free cert <?php echo $row['model']; ?> ">
<title>تحميل جميع ملفات سيرت <?php echo $row['company']; ?> <?php echo $row['model_name']; ?> <?php echo $row['model']; ?> مجانا </title>
...
></span></a>
            <ul class=" dropdown-menu text-right" >
              ...
              <li><a class="text-right" href="../../EN/Samsung/View-Cert-Samsung.php?model=<?php echo $row['model']; ?>">English</a></li>
            </ul>
          </li>
    ...
    <div class="row">
      <div class="col-xs-12 visible-xs">
        <div class="all-device-mobile">
          <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" > <?php echo $row['company']; ?>  <?php echo $row['model']; ?> تحميل ملفات سيرت لهاتف </h4>
        </div>
   <?php  foreach($roms as $row){ ?>

       <div class="mobile-table btn-block text-center "> <a href="Download-Cert.php?ceid=<?php echo $row['ceid']; ?>">  <div class="file-type ">سيرت<p><pr> <span class="glyphicon glyphicon glyphicon-eye-open"></span> <?php echo $row['view']; ?></p></div> <?php echo $row['model_name']; ?>  - <?php echo $row['model']; ?>  - <?php echo $row['key_id']; ?> <br> IMEI : <?php echo $row['imei']; ?> </a></div>
                          <?php }     ?>
              ...
              <tbody>
                <?php  foreach($roms as $row){ ?>
                  <tr>
                    ...
                    <td><h4> ملف سيرت  </h4></td>
                    <td><h4><?php echo $row['model_name']; ?></h4></td>
                    <td><h4><?php echo $row['model']; ?></h4></td>
                    <td><h4><?php echo $row['key_id']; ?> </h4></td>
                    <td><h4><?php echo $row['imei']; ?> </h4></td>
                    <td><h4><?php echo $row['date']; ?> </h4></td>

                    <td><a class="link-main" href="Download-Cert.php?ceid=<?php echo $row['ceid']; ?>" > تحميل  <span class="fa fa-chevron-right"> </span></a></td>
                  </tr>
                  <?php }   ?>
              </tbody>
            </table>
