...
<meta name="description" content=" تحميل مودم لهاتف <?php echo $row['Companny']; ?> <?php echo $row['Model_Name']; ?> <?php echo $row['Model']; ?> جميع الاصدارات والحمايات">
...
<title> مودم <?php echo $row['Model_Name']; ?> <?php echo $row['Model']; ?> </title>
...
></span></a>
            <ul class=" dropdown-menu text-right" >
              ...
              <li><a class="text-right" href="../../EN/Samsung/View_Modem.php?Model=<?php echo $row['Model']; ?>">English</a></li>
            </ul>
          </li>
    ...
    <div class="row">
      <div class="col-xs-12 visible-xs">
        <div class="all-device-mobile">
          <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" > <?php echo $row['Model_Name']; ?> -<?php echo $row['Model']; ?> ملفات المودم المتوفرة لهاتف  </h4>
        </div>
   <?php  foreach($roms as $row){ ?>

       <div class="mobile-table btn-block text-center "> <a href="Download_Modem.php?MOid=<?php echo $row['MOid']; ?>"> <div class="file-type "> <?php echo $row['type']; ?> <p><pr> <span class="glyphicon glyphicon glyphicon-eye-open"></span> <?php echo $row['view']; ?></p></div>
        <?php echo $row['Model_Name']; ?> - <?php echo $row['Model']; ?>  - <?php if($row['Besband'] == "0"){ echo $row['Protect'];} else { echo $row['Besband']; }?> -  <?php echo $row['Version']; ?>  </a></div>
                          <?php }     ?>
            ...
            <table class="table text-capitalize">
              <thead>
                <tr>
                  ...
                  <th><h4>   الشركة المصنعة </h4></th>
                  <th><h4>نوع المودم</h4></th>
                  <th><h4>اسم الجهاز</h4></th>
                  <th><h4>رقم الطراز</h4></th>
                 <th><h4> الحماية  /    البيسباند  </h4></th>
                  <th><h4> الاصدار </h4></th>
                  <th><h4>تاريخ الرفع</h4></th>
                  <th><h4>تحميل</h4></th>
                </tr>
              </thead>
              <tbody>
                ...
                <?php  foreach($roms as $row){ ?>
                  <tr>
                    ...
                    <td><h4> <?php if($row['Besband'] == "0"){ echo $row['Protect'];} else { echo $row['Besband']; }?> </h4></td>
                    <td><h4> <?php echo $row['Version']; ?></h4></td>
                    <td><h4>  <?php echo $row['date']; ?> </h4></td>

                    <td><a class="link-main" href="Download_Modem.php?MOid=<?php echo $row['MOid']; ?>" >تحميل <span class="fa fa-chevron-right"> </span></a></td>
                  </tr>
                  <?php }   ?>
              </tbody>
            </table>
