...
<html lang="ar">
<head>
<title>روم <?php echo $row['Model_Name']; ?>  <?php echo $row['Modell']; ?> </title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="description" content="تحميل جميع رومات هاتف  <?php echo $row['Model_Name']; ?> , <?php echo $row['Modell']; ?> الرسمية بجميع الاصدارات والحمايات والبيسباندات">
<meta name="keywords" content=" روم <?php echo $row['Model_Name']; ?>, روم <?php echo $row['Modell']; ?>, روم عربي <?php echo $row['Modell']; ?>, روم معرب <?php echo $row['Modell']; ?>, روم رسمي <?php echo $row['Modell']; ?>, تعريب <?php echo $row['Modell']; ?>,rom <?php echo $row['Modell']; ?>,rom <?php echo $row['Model_Name']; ?>,rom arabic <?php echo $row['Modell']; ?>, full rom <?php echo $row['Modell']; ?>,تعريب <?php echo $row['Model_Name']; ?>">
...
></span></a>
            <ul class=" dropdown-menu text-right" >
              <li class="arabic text-right" ><a  href="View_Rom.php?Model=<?php echo $row['Modell']; ?>">العربية</a></li>
              <li role="separator" class="divider"></li>
              <li><a class="text-right" href="../../EN/Samsung/View_Rom.php?Model=<?php echo $row['Modell']; ?>">English</a></li>
            </ul>
          </li>
    ...
    <div class="row">
      <div class="col-xs-12 visible-xs">
        <div class="all-device-mobile">
          <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" > <?php echo $row['Model_Name']; ?> - <?php echo $row['Modell']; ?>  الرومات الرسمية للهاتف </h4>
        </div>
   <?php  foreach($roms as $row){ ?>

       <div class="mobile-table btn-block text-center "> <a href="Download_Rom.php?Oid=<?php echo $row['Oid']; ?>">  <div class="file-type ">روم رسمي<p><pr> <span class="glyphicon glyphicon glyphicon-eye-open"></span> <?php echo $row['view']; ?></p></div><?php echo $row['Model_Name']; ?>  - <?php echo $row['Modell']; ?>  - <?php echo $row['Besband']; ?>  -   V( <?php echo $row['Vrsion']; ?> ) </a></div>
                          <?php }     ?>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12  hidden-xs">
          <div class="main-table">
            <div class="all-device ">
              <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" > <?php echo $row['Model_Name']; ?> - <?php echo $row['Modell']; ?> </h4>
            </div>
              ...
              <tbody>
                ...
                <?php  foreach($roms as $row){ ?>
                  <tr>
                    ...
                    <td><h4><?php echo $row['Companny']; ?> ( روم رسمي ) </h4></td>
                    <td><h4><?php echo $row['Model_Name']; ?></h4></td>
                    <td><h4><?php echo $row['Modell']; ?></h4></td>
                    <td><h4><?php echo $row['Besband']; ?> / <?php echo $row['Languages']; ?></h4></td>
                     <td><h4><?php echo $row['Vrsion']; ?></h4></td>

                    <td><a class="link-main" href="Download_Rom.php?Oid=<?php echo $row['Oid']; ?>" >تحميل <span class="fa fa-chevron-right"> </span></a></td>
                  </tr>
                  <?php }   ?>
              </tbody>
            </table>
