...
<meta name="description" content="تحميل روم رباعي - 4 ملفات - لهاتف <?php echo $row['Companny']; ?> <?php echo $row['Model_Name']; ?> <?php echo $row['Model']; ?> جميع الاصدارات والحمايات">
...
<title>روم 4 ملفات  <?php echo $row['Model_Name']; ?> <?php echo $row['Model']; ?></title>
...
></span></a>
            <ul class=" dropdown-menu text-right" >
              ...
              <li><a class="text-right" href="../../EN/Samsung/View_Rom4.php?Model=<?php echo $row['Model']; ?>">English</a></li>
            </ul>
          </li>
    ...
    <div class="row">
      <div class="col-xs-12 visible-xs">
        <div class="all-device-mobile">
          <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" >  <?php echo $row['Model_Name']; ?> - <?php echo $row['Model']; ?>  رومات 4 ملفات  لهاتف  </h4>
        </div>
   <?php  foreach($roms as $row){ ?>

        <div class="mobile-table btn-block text-center "> <a href="Download_Rom4.php?Fid=<?php echo $row['Fid']; ?>">  <div class="file-type ">روم 4 ملفات<p><pr> <span class="glyphicon glyphicon glyphicon-eye-open"></span> <?php echo $row['view']; ?></p></div><?php echo $row['Model_Name']; ?>   - <?php echo $row['Model']; ?> - <?php echo $row['Besband']; ?>  -   ( <?php echo $row['Vrsion']; ?> ) </a></div>
                          <?php }     ?>
              ...
              <tbody>
                ...
                <?php  foreach($roms as $row){ ?>
                  <tr>
                    ...
                    <td><h4><?php echo $row['Companny']; ?>  ( روم 4 ملفات ) </h4></td>
                    ...
                    <td><a class="link-main" href="Download_Rom4.php?Fid=<?php echo $row['Fid']; ?>" >تحميل <span class="fa fa-chevron-right"> </span></a></td>
                  </tr>
                  <?php }   ?>
              </tbody>
            </table>
