...
<meta name="description" content="تحميل روت وريكفري <?php echo $row['Model_Name']; ?> <?php echo $row['Model']; ?> ">
...
<title> روت و ريكفري <?php echo $row['Model_Name']; ?> <?php echo $row['Model']; ?> </title>
...
></span></a>
            <ul class=" dropdown-menu text-right" >
              ...
              <li><a class="text-right" href="../../EN/Samsung/View_Root.php?Model=<?php echo $row['Model']; ?>">English</a></li>
            </ul>
          </li>
    ...
    <div class="row">
      <div class="col-xs-12 visible-xs">
        <div class="all-device-mobile">
          <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" > <?php echo $row['Companny']; ?> <?php echo $row['Model']; ?> طرق الروت والريكفري المتوفرة للهاتف </h4>
        </div>
   <?php  foreach($roms as $row){ ?>

       <div class="mobile-table btn-block text-center "> <a href="Download_Root.php?ROid=<?php echo $row['ROid']; ?>"> <div class="file-type ">روت و ريكفري <p><pr> <span class="glyphicon glyphicon glyphicon-eye-open"></span> <?php echo $row['view']; ?></p></div>
         <?php echo $row['Model_Name']; ?>   - <?php echo $row['Mod_Root']; ?>  -   ( <?php echo $row['Version']; ?> ) </a></div>
                          <?php }     ?>
            ...
            <table class="table text-capitalize">
              <thead>
                <tr>
                  ...
                  <th><h4>الحماية / الاصدار</h4></th>
                                    <th><h4>طريقة الروت</h4></th>
              ...
              <tbody>
                ...
                <?php  foreach($roms as $row){ ?>
                  <tr>
                    ...
                    <td><h4><?php echo $row['Companny']; ?>  ( روت ) </h4></td>
                    ...
                    <td><a class="link-main" href="Download_Root.php?ROid=<?php echo $row['ROid']; ?>" >تحميل  <span class="fa fa-chevron-right"> </span></a></td>
                  </tr>
                  <?php }   ?>
              </tbody>
            </table>
