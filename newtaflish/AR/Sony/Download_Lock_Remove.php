...
$stmt = $connect->prepare(" SELECT * FROM `lock_remov` WHERE `LRid` = ?");
...
$view = $row['view'] +1;
$stmt = $connect->prepare("UPDATE `lock_remov` SET view= ?  WHERE `LRid` = ?");
...
<meta name="description" content="تحميل ملف ازالة القفل - ازالة النمط- لهاتف سوني <?php echo $row['Model_Name']; ?> موديل <?php echo $row['Model']; ?> بيسباند : <?php echo $row['Besband']; ?>">
...
<title>تحمبل ملف ازالة قفل - نمط  <?php echo $row['Model_Name']; ?> <?php echo $row['Model']; ?> </title>
...
></span></a>
            <ul class=" dropdown-menu text-right" >
              ...
              <li><a class="text-right" href="../../EN/Sony/Download_Lock_Remove.php?LRid=<?php echo $row['LRid']; ?>">English</a></li>
            </ul>
          </li>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12  col-xs-12">
          ...
          <div class="col-lg-8 col-md-8 col-sm-8  col-xs-12">
            <div class="all-device">
              <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" ><?php echo $row['Model_Name']; ?>  <?php echo $row['Model']; ?> تحميل ملف ازالة قفل هاتف </h4>
            </div>
            <div class="info-device" dir="rtl"> <br>
              <li>
                <h4> <p class="type"> <span class="glyphicon glyphicon-hand-left"> </span>   نوع الملف : </p>  ملف ازالة القفل FTF .</h4>
              </li>
              <br>
              <li>
                <h4> <p class="type"> <span class="glyphicon glyphicon-hand-left"> </span>   الشركة المصنعة : </p>  SONY  .</h4>
              </li>
              <br>
              <li>
