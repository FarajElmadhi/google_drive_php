...
$stmt = $connect->prepare(" SELECT * FROM `sonyoffecial` WHERE `SOid` = ?");
...
$view = $row['view'] +1;
$stmt = $connect->prepare("UPDATE `sonyoffecial` SET view= ?  WHERE `SOid` = ?");
...
<meta name="description" content="تحميل الروم الرسمي لهاتف سوني <?php echo $row['Model_Name']; ?> موديل : <?php echo $row['Model']; ?> اصدار : <?php echo $row['Version']; ?> بيسباند : <?php echo $row['Besband']; ?>">
...
<title>تحميل روم <?php echo $row['Companny']; ?> <?php echo $row['Model_Name']; ?> موديل :<?php echo $row['Model']; ?> اصدار :<?php echo $row['Version']; ?> بيسباند <?php echo $row['Besband']; ?> </title>
...
></span></a>
            <ul class=" dropdown-menu text-right" >
              ...
              <li><a class="text-right" href="../../EN/Sony/Download_Rom.php?SOid=<?php echo $row['SOid']; ?>">English</a></li>
            </ul>
          </li>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12  col-xs-12">
          ...
          <div class="col-lg-8 col-md-8 col-sm-8  col-xs-12">
            <div class="all-device">
              <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" ><?php echo $row['Companny']; ?>  <?php echo $row['Model']; ?> تحميل الروم الرسمي لهاتف</h4>
            </div>
            <div class="info-device" dir="rtl"> <br>
              <li>
                <h4> <p class="type"> <span class="glyphicon glyphicon-hand-left"> </span>   نوع الملف : </p>  روم رسمي .</h4>
              </li>
              <br>
              <li>
              ...
              <br>
               <li>
               <h4> <p class="type"> <span class="glyphicon glyphicon-hand-left"> </span>    اصدار أندرويد : </p> <?php echo $row['Version']; ?> .</h4>
              </li>
              <br>
