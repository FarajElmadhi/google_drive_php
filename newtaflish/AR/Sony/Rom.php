...
$stmt = $connect->prepare(" SELECT * FROM sony_offecial_rom ORDER BY Model ASC");
$stmt->execute();
$roms = $stmt->fetchAll();
...
<meta name="description" content="تحميل جيع رومات سوني اكسبيريا بروابط مباشرة جميع الموديلات وجميع الاصدارات">
<meta name="keywords" content="روم سوني,تحميل روم سوني الرسمية,تحميل جميع رومات سوني الرسمية,فلاشات سوني,sony rom">
<title> رومات سوني الرسمية  </title>
...
></span></a>
            <ul class=" dropdown-menu text-right" >
              ...
              <li><a class="text-right" href="../../EN/Sony/Rom.php">English</a></li>
            </ul>
          </li>
    ...
    <div class="row">
      <div class="col-xs-12 visible-xs">
        <div class="all-device-mobile">
          <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" >الرومات الرسمية لهواتف سوني </h4>
        </div>
        <?php  foreach($roms as $row){ ?>
          <div class="mobile-table btn-block text-center "> <a href="View_Rom.php?Model=<?php echo $row['Model']; ?>">  <div class="file-type ">روم رسمي<p><pr> <span class="glyphicon glyphicon glyphicon-eye-open"></span> <?php echo $row['view']; ?></p></div> <?php echo $row['Model_Name']; ?> - <?php echo $row['Model']; ?> </a></div>
          <?php }   ?>
      </div>
    </div>
    <div>
              ...
              <tbody>
                <?php  foreach($roms as $row){ ?>
                  <tr>
                    ...
                    <td><a class="link-main" href="View_Rom.php?Model=<?php echo $row['Model']; ?>" > عرض <span class="fa fa-chevron-right"> </span></a></td>
                  </tr>
                  <?php }    ?>
              </tbody>
            </table>
