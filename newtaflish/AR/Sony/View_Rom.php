...
$stmt = $connect->prepare(" SELECT * FROM `sonyoffecial` WHERE Model = ?");
...
<meta name="description" content="تحميل الروم الرسمي لهاتف سوني <?php echo $row['Model_Name']; ?> موديل : <?php echo $row['Model']; ?> جميع الاصدارات">
<meta name="keywords" content=" روم <?php echo $row['Model_Name']; ?>, روم <?php echo $row['Model']; ?>, روم عربي <?php echo $row['Model']; ?>, روم معرب <?php echo $row['Modell']; ?>, روم رسمي <?php echo $row['Model']; ?>, تعريب <?php echo $row['Modell']; ?>,rom <?php echo $row['Model']; ?>,rom <?php echo $row['Model_Name']; ?>,rom arabic <?php echo $row['Modell']; ?>, full rom <?php echo $row['Model']; ?>,تعريب <?php echo $row['Model_Name']; ?>">
<title> رومات <?php echo $row['Model_Name']; ?> ~ <?php echo $row['Model']; ?> </title>
...
></span></a>
            <ul class=" dropdown-menu text-right" >
              ...
              <li><a class="text-right" href="../../EN/Sony/View_Rom.php?Model=<?php echo $row['Model']; ?>">English</a></li>
            </ul>
          </li>
    ...
    <div class="row">
      <div class="col-xs-12 visible-xs">
        <div class="all-device-mobile">
          <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" ><?php echo $row['Companny']; ?>  <?php echo $row['Model']; ?>  الرومات الرسمية لهاتف </h4>
        </div>
   <?php  foreach($roms as $row){ ?>

       <div class="mobile-table btn-block text-center "> <a href="Download_Rom.php?SOid=<?php echo $row['SOid']; ?>">  <div class="file-type ">روم رسمي<p><pr> <span class="glyphicon glyphicon glyphicon-eye-open"></span> <?php echo $row['view']; ?></p></div><?php echo $row['Model_Name']; ?>  - <?php echo $row['Besband']; ?>  -   ( <?php echo $row['Version']; ?> ) </a></div>
                          <?php }     ?>
              ...
              <tbody>
                ...
                <?php  foreach($roms as $row){ ?>
                  <tr>
                    ...
                    <td><h4><?php echo $row['Companny']; ?>  ( STOCK ROM ) </h4></td>
                    ...
                    <td><a class="link-main" href="Download_Rom.php?SOid=<?php echo $row['SOid']; ?>"> تحميل <span class="fa fa-chevron-right"> </span></a></td>
                  </tr>
                  <?php }   ?>
              </tbody>
            </table>
