...
<meta name="description" content="Download firmware <?php echo $row['Model_Name']; ?> <?php echo $row['Model']; ?>: <?php echo $row['Identifier']; ?>  : <?php echo $row['Version']; ?>">
<meta name="keywords" content="firmware <?php echo $row['Model']; ?>,firmware <?php echo $row['Model_Name']; ?>,firmware <?php echo $row['Identifier']; ?>,restore <?php echo $row['Model']; ?>,restore <?php echo $row['Model_Name']; ?>,restore <?php echo $row['Identifier']; ?>,software <?php echo $row['Model']; ?>,software <?php echo $row['Model_Name']; ?>,software <?php echo $row['Identifier']; ?>,format <?php echo $row['Model']; ?>,hard reset <?php echo $row['Model']; ?>,hard reset<?php echo $row['Model_Name']; ?>,format  <?php echo $row['Model_Name']; ?>,فيرموير ابفون,فلاشات ايفون,رومات ايفون,استعادة ايفون,رستور ايفون,حذف رمز ايفون,ازالة باسوورد ايفون,تجاوز قفل ايفون, تفليش ايفون,فرمتة ايفون,فورمات ايفون,فيرموير ايباد,فلاشة ايبادروم ايباد,ازالة رمز ايباد ">
<title>Download Firmware <?php echo $row['Model']; ?> <?php echo $row['Model_Name']; ?>: <?php echo $row['Identifier']; ?> : <?php echo $row['Version']; ?> </title>
...
></span> LANGUAGE <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li class="arabic"> <a  href="../../AR/Apple/Download_Firmware.php?ifid=<?php echo $row['ifid']; ?>">العربية</a></li>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown active "> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">APPLE<span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li><a href="Firmware.php">FIRMWARE IPSW</a></li>
            </ul>
          </li>
    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="ads-avarege">
             ...
             <?php if($_GET['ifid'] != 73  ){echo $ads['ads_main']; } ?>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12  col-xs-12">
          <div class="col-lg-2 col-md-2 col-sm-2  hidden-xs">
            <div class="ads-side-download">
                             <?php if($_GET['ifid'] != 73  ){echo $ads['ads_side']; } ?>

            </div>
          </div>
          <div class="col-lg-8 col-md-8 col-sm-8  col-xs-12">
            <div class="all-device">
              <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" >DOWNLOAD FIRMWARE  <?php echo $row['Model_Name']; ?> (<?php echo $row['Model']; ?>)  </h4>
            </div>
            <div class="info-device"> <br>
              <li>
                <h4> <p class="type"> <span class="glyphicon glyphicon-hand-right"> </span>   TYPE FILE : </p>  FIRMWARE IPSW .</h4>
              </li>
              <br>
              <li>
              ...
              <br>
               <li>
                <h4> <p class="type"> <span class="glyphicon glyphicon-hand-right"> </span>    ID : </p> <?php echo $row['Identifier']; ?> .</h4>
              </li>
              <br>
               <li>
               <h4> <p class="type"> <span class="glyphicon glyphicon-hand-right"> </span>    VERSION : </p> <?php echo $row['Version']; ?> .</h4>
              </li>
              <br>
              ...
              <div class="ads-download">
                 <?php if($_GET['ifid'] != 73  ){echo $ads['ads_d1']; } ?>
...
"> </span></a></li>
              <br>
              <div class="ads-download">
                  <?php if($_GET['ifid'] != 73  ){echo $ads['ads_d2']; } ?>
              </div>
              <br>
            </div>
          </div>
  ...
  <div class="footer-area">
    <div class="row">
     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <?php if($_GET['ifid'] != 73  ){echo $ads['ads_match']; } ?>
                   </div>
      </div>
    </div>
  </div>
