...
<meta name="description" content="Download latest firmware ios for apple device. iphone,ipad,ipod,apple watch,apple tv">
<meta name="keywords" content="iphone firmware latest,restore iphone,restore ipad,latest firmware ipad">
<title> Firmware Apple </title>
...
></span> LANGUAGE <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li class="arabic"><a  href="../../AR/Apple/Firmware.php">العربية</a></li>
    ...
    <div class="row">
      <div class="col-xs-12 visible-xs">
        <div class="all-device-mobile">
          <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" >IOS FIRMWARE FOR APPLE DEVICE</h4>
        </div>
        <?php  foreach($roms as $row){ ?>
          <div class="mobile-table btn-block text-center "> <a href="View_Firmware.php?Model=<?php echo $row['Model']; ?>"> <div class="file-type ">IPSW<p><pr> <span class="glyphicon glyphicon glyphicon-eye-open"></span> <?php echo $row['view']; ?></p></div>  <?php echo $row['Model_Name']; ?> - <?php echo $row['Model']; ?> - <?php echo $row['Identifier']; ?>  </a></div>
          <?php }   ?>
      </div>
    </div>
    <div>
              ...
              <tbody>
                <?php  foreach($roms as $row){ ?>
                  <tr>
                    ...
                    <td><a class="link-main" href="View_Firmware.php?Model=<?php echo $row['Model']; ?>" >VIEW <span class="fa fa-chevron-right"> </span></a></td>
                  </tr>
                  <?php }    ?>
              </tbody>
            </table>
