...
$stmt = $connect->prepare(" SELECT * FROM `ifirmware` WHERE Model = ?");
...
<meta name="description" content="Download firmware <?php echo $row['Model_Name']; ?> ,<?php echo $row['Model']; ?>,<?php echo $row['Identifier']; ?> latest version  ">
...
<title>Firmware <?php echo $row['Model_Name']; ?> <?php echo $row['Model']; ?> <?php echo $row['Identifier']; ?> </title>
...
></span> LANGUAGE <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li class="arabic"><a  href="../../AR/Apple/View_Firmware.php?Model=<?php echo $row['Model']; ?>">العربية</a></li>
    ...
    <div class="row">
      <div class="col-xs-12 visible-xs">
        <div class="all-device-mobile">
          <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" >FIRMWARES  <?php echo $row['Model_Name']; ?> (<?php echo $row['Model']; ?>)</h4>
        </div>
   <?php  foreach($roms as $row){ ?>

       <div class="mobile-table btn-block text-center "> <a href="Download_Firmware.php?ifid=<?php echo $row['ifid']; ?>"> <div class="file-type ">IPSW<p><pr> <span class="glyphicon glyphicon glyphicon-eye-open"></span> <?php echo $row['view']; ?></p></div> <?php echo $row['Model_Name']; ?> -  <?php echo $row['Model']; ?>  - <?php echo $row['Identifier']; ?>  -   ( <?php echo $row['Version']; ?> ) </a></div>
                          <?php }     ?>
                ...
                <?php  foreach($roms as $row){ ?>
                  <tr>
                    ...
                    <td><h4><?php echo $row['Identifier']; ?></h4></td>
                     <td><h4><?php echo $row['Version']; ?></h4></td>

                    <td><a class="link-main" href="Download_Firmware.php?ifid=<?php echo $row['ifid']; ?>" >VIEW <span class="fa fa-chevron-right"> </span></a></td>
                  </tr>
                  <?php }   ?>
              </tbody>
            </table>
