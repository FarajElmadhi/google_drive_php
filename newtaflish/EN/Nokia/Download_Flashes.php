...
<meta name="description" content="Download Firmware  <?php echo $row['Companny']; ?> <?php echo $row['Model_Name']; ?> <?php echo $row['Model']; ?>  <?php echo $row['Version']; ?>">
...
<title>Download Flash File <?php echo $row['Companny']; ?> Model : <?php echo $row['Model']; ?> Version : <?php echo $row['Version']; ?></title>
...
></span> LANGUAGE <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li class="arabic"> <a  href="../../AR/Nokia/Download_Flashes.php?nfid=<?php echo $row['nfid']; ?>">العربية</a></li>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12  col-xs-12">
          ...
          <div class="col-lg-8 col-md-8 col-sm-8  col-xs-12">
            <div class="all-device">
              <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" >STOCK FLASH FOR <?php echo $row['Companny']; ?>  <?php echo $row['Model']; ?> - <?php echo $row['Version']; ?> </h4>
            </div>
            <div class="info-device"> <br>
              <li>
                <h4> <p class="type"> <span class="glyphicon glyphicon-hand-right"> </span>   TYPE FILE : </p>  FLASH FILE .</h4>
              </li>
              <br>
              <li>
