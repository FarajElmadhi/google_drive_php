...
<meta name="description" content="Download Firmware <?php echo $row['Companny']; ?> <?php echo $row['Model_Name']; ?> <?php echo $row['Model']; ?>  all version">
<meta name="keywords" content="firmware <?php echo $row['Model']; ?>, firmware <?php echo $row['Model_Name']; ?>,arabic flashes <?php echo $row['Model']; ?>,hard rsest nokia <?php echo $row['Model_Name']; ?>,repaire imei <?php echo $row['Model']; ?>,format <?php echo $row['Model_Name']; ?>,fix imei <?php echo $row['Companny']; ?>,تقييد نوكيا,تتريك نوكيا, nokia imei null,repaire imei nokia,اصلاح ايمي نوكيا,جمركة نوكيا">
...
></span> LANGUAGE <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li class="arabic"><a  href="../../AR/Nokia/View_Flashes.php?Model=<?php echo $row['Model']; ?>">العربية</a></li>
    ...
    <div class="row">
      <div class="col-xs-12 visible-xs">
        <div class="all-device-mobile">
          <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" >FLASH FILE <?php echo $row['Companny']; ?>  <?php echo $row['Model']; ?> </h4>
        </div>
   <?php  foreach($roms as $row){ ?>

       <div class="mobile-table btn-block text-center "> <a href="Download_Flashes.php?nfid=<?php echo $row['nfid']; ?>">  <div class="file-type ">FLASH FILE<p><pr> <span class="glyphicon glyphicon glyphicon-eye-open"></span> <?php echo $row['view']; ?></p></div> <?php echo $row['Model_Name']; ?>  - <?php echo $row['Model']; ?>  -    V( <?php echo $row['Version']; ?> ) </a></div>
                          <?php }     ?>
              ...
              <tbody>
                ...
                <?php  foreach($roms as $row){ ?>
                  <tr>
                    ...
                    <td><h4><?php echo $row['Companny']; ?>  ( STOCK FLASH FILE ) </h4></td>
                    <td><h4><?php echo $row['Model_Name']; ?></h4></td>
                    <td><h4><?php echo $row['Model']; ?></h4></td>
                     <td><h4><?php echo $row['Version']; ?></h4></td>

                    <td><a class="link-main" href="Download_Flashes.php?nfid=<?php echo $row['nfid']; ?>" >VIEW <span class="fa fa-chevron-right"> </span></a></td>
                  </tr>
                  <?php }   ?>
              </tbody>
            </table>
