...
<meta name="description" content="Download All Cert Files for Samsung Galaxy For All Version">
<meta name="keywords" content="samsung cert,repaire imei samsung,fix imei null samsung,download free cert samsung,cert generator samsung,clone cert samsung,cert samsung working,new cert samsung">
<title>Download Cert File Samsung </title>
...
></span> LANGUAGE <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li class="arabic"><a  href="../../AR/Samsung/Cert-Samsung.php">العربية</a></li>
    ...
    <div class="row">
      <div class="col-xs-12 visible-xs">
        <div class="all-device-mobile">
          <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" >CERT FILES FOR SAMSUNG</h4>
        </div>
        <?php  foreach($roms as $row){ ?>
          <div class="mobile-table btn-block text-center "> <a href="View-Cert-Samsung.php?model=<?php echo $row['model']; ?>"> <div class="file-type "> CERT FILE<p><pr> <span class="glyphicon glyphicon glyphicon-eye-open"></span> <?php echo $row['view']; ?></p></div><?php echo $row['model_name']; ?> - <?php echo $row['model']; ?> - <?php echo $row['keyid']; ?> </a></div>
          <?php }   ?>
      </div>
    </div>
    <div>
              ...
              <tbody>
                <?php  foreach($roms as $row){ ?>
                  <tr>
                    ...
                    <td><h4><?php echo $row['company']; ?>  ( CERT FILE ) </h4></td>
                    <td><h4><?php echo $row['model_name']; ?></h4></td>
                    <td><h4><?php echo $row['model']; ?></h4></td>
                    <td><h4><?php echo $row['keyid']; ?></h4></td>

                    <td><a class="link-main" href="View-Cert-Samsung.php?model=<?php echo $row['model']; ?>" >VIEW <span class="fa fa-chevron-right"> </span></a></td>
                  </tr>
                  <?php }    ?>
              </tbody>
            </table>
