...
$stmt = $connect->prepare(" SELECT * FROM combination_device ORDER BY Model ASC");
$stmt->execute();
$roms = $stmt->fetchAll();
...
<meta name="description" content="Download All Combination Rom Files For Samsung">
<meta name="keywords" content="combination rom,روم كومبينيشن,تخطي حساب غوغل بروم كومبينيشن,remove frp combination, bypasse frp, bypasse google account">
<title>Combination Rom For Samsung</title>
...
></span> LANGUAGE <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li class="arabic"><a  href="../../AR/Samsung/Combination.php">العربية</a></li>
              <li role="separator" class="divider"></li>
              <li> <a href="Combination.php">English</a></li>
            </ul>
          </li>
        </ul>
    ...
    <div class="row">
      <div class="col-xs-12 visible-xs">
        <div class="all-device-mobile">
          <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" >COMBINATION ROM FOR SAMSUNG</h4>
        </div>
        <?php  foreach($roms as $row){ ?>
          <div class="mobile-table btn-block text-center "> <a href="Combination_View.php?Model=<?php echo $row['Model']; ?>"> <div class="file-type "> COMBINATION <p><pr> <span class="glyphicon glyphicon glyphicon-eye-open"></span> <?php echo $row['view']; ?></p></div> <?php echo $row['Model_Name']; ?> - <?php echo $row['Model']; ?> </a></div>
          <?php }   ?>
      </div>
    </div>
    <div>
              ...
              <tbody>
                <?php  foreach($roms as $row){ ?>
                  <tr>
                    ...
                    <td><a class="link-main" href="Combination_View.php?Model=<?php echo $row['Model']; ?>" >VIEW <span class="fa fa-chevron-right"> </span></a></td>
                  </tr>
                  <?php }    ?>
              </tbody>
            </table>
