...
<meta name="description" content="Dowload Combination Rom File For  <?php echo $row['Model_Name']; ?> <?php echo $row['Model']; ?> All Baseband and version">
...
<title>Combination Rom For <?php echo $row['Model_Name']; ?> <?php echo $row['Model']; ?>  </title>
...
></span> LANGUAGE <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li class="arabic"><a  href="../../AR/Samsung/Combination_View.php?Model=<?php echo $row['Model']; ?>">العربية</a></li>
              <li role="separator" class="divider"></li>
              <li> <a href="Combination_View.php?Model=<?php echo $row['Model']; ?>">English</a></li>
            </ul>
          </li>
        </ul>
  ...
  <div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      <div class="ads-avarege">
        ...
        <?php if($_GET['Model'] !== "SM-N920C" && $_GET['Model'] !== "SM-N920T"){
    ...
    <div class="row">
      <div class="col-xs-12 visible-xs">
        <div class="all-device-mobile">
          <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" >COMBINATION ROM FOR <?php echo $row['Model_Name']; ?> - <?php echo $row['Model']; ?></h4>
        </div>
   <?php  foreach($roms as $row){ ?>

       <div class="mobile-table btn-block text-center "> <a href="Download_Combination.php?Cid=<?php echo $row['Cid']; ?>"><div class="file-type "> COMBINATION <p><pr> <span class="glyphicon glyphicon glyphicon-eye-open"></span> <?php echo $row['view']; ?></p></div>  <?php echo $row['Model_Name']; ?>  - <?php echo $row['Model']; ?> - <?php echo $row['Besband']; ?>     </a></div>
                          <?php }     ?>
              ...
              <tbody>
                ...
                <?php  foreach($roms as $row){ ?>
                  <tr>
                    ...
                    <td><h4><?php echo $row['Companny']; ?>  ( COMBINATION ) </h4></td>
                    <td><h4><?php echo $row['Model_Name']; ?></h4></td>
                    <td><h4><?php echo $row['Model']; ?></h4></td>
                    <td><h4><?php echo $row['Besband']; ?> </h4></td>

                    <td><a class="link-main" href="Download_Combination.php?Cid=<?php echo $row['Cid']; ?>" >VIEW <span class="fa fa-chevron-right"> </span></a></td>
                  </tr>
                  <?php }   ?>
              </tbody>
            </table>
