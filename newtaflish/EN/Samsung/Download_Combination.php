...
$stmt = $connect->prepare(" SELECT * FROM `combination` WHERE `Cid` = ?");
...
$view = $row['view'] +1;
$stmt = $connect->prepare("UPDATE `combination` SET view= ?  WHERE `Cid` = ?");
...
<meta name="description" content="Download Combination Rom For  <?php echo $row['Model_Name']; ?> , Model : <?php echo $row['Model']; ?> ,Bsband: <?php echo $row['Besband']; ?> ">
<meta name="keywords" content="combination <?php echo $row['Model']; ?>,costum rom <?php echo $row['Model']; ?>,root <?php echo $row['Model']; ?>,root <?php echo $row['Model_Name']; ?>,recovery <?php echo $row['Model']; ?>,twrp <?php echo $row['Model']; ?>,combination rom <?php echo $row['Model']; ?>,philz <?php echo $row['Model']; ?>,unofficial recovery <?php echo $row['Model']; ?>,repaire imei <?php echo $row['Model']; ?>,fix imei <?php echo $row['Model']; ?>,kayıtlı <?php echo $row['Model']; ?>,root <?php echo $row['Model']; ?>,root without pc <?php echo $row['Model']; ?>,كومبينيشن النهائي <?php echo $row['Model']; ?>, كومبينيشن خالي من المشاكل <?php echo $row['Model']; ?>,روت مجرب  <?php echo $row['Model']; ?>,final root <?php echo $row['Model']; ?>,repaire imei <?php echo $row['Model']; ?>,null imei <?php echo $row['Model']; ?> ">
<title>Download Combination <?php echo $row['Model_Name']; ?>~<?php echo $row['Model']; ?>~<?php echo $row['Besband']; ?>  </title>
...
></span> LANGUAGE <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li class="arabic"> <a  href="../../AR/Samsung/Download_Combination.php?Cid=<?php echo $row['Cid']; ?>">العربية</a></li>
              <li role="separator" class="divider"></li>
              <li> <a href="Download_Combination.php?Cid=<?php echo $row['Cid']; ?>">English</a></li>
            </ul>
          </li>
        </ul>
    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="ads-avarege">
         <?php
         if($_GET['Cid'] != 19 && $_GET['Cid'] != 78 && $_GET['Cid'] != 104 && $_GET['Cid'] != 147 && $_GET['Cid'] != 336 && $_GET['Cid'] != 366  && $_GET['Cid'] != 364  && $_GET['Cid'] != 197  && $_GET['Cid'] != 53 && $_GET['Cid'] != 124   && $_GET['Cid'] != 147  && $_GET['Cid'] != 19  && $_GET['Cid'] != 366){
        ...
        <div class="col-lg-12 col-md-12 col-sm-12  col-xs-12">
          ...
          <div class="col-lg-8 col-md-8 col-sm-8  col-xs-12">
            <div class="all-device">
              <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" >DOWNLOAD COMBINATION ROM FOR <?php echo $row['Companny']; ?>  <?php echo $row['Model']; ?> </h4>
            </div>
            <div class="info-device"> <br>
              <li>
                <h4> <p class="type"> <span class="glyphicon glyphicon-hand-right"> </span>   TYPE FILE : </p>  COMBINATION .</h4>
              </li>
              <br>
              <li>
...
"> </span></a></li>
  ...
  <div class="footer-area">
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="ads-footer"> <?php 
                    if($_GET['Cid'] != 19 && $_GET['Cid'] != 78 && $_GET['Cid'] != 104 && $_GET['Cid'] != 147 && $_GET['Cid'] != 336 && $_GET['Cid'] != 366  && $_GET['Cid'] != 364  && $_GET['Cid'] != 197  && $_GET['Cid'] != 53 && $_GET['Cid'] != 124   && $_GET['Cid'] != 147  && $_GET['Cid'] != 19  && $_GET['Cid'] != 366){echo $ads['ads_match']; } ?>  </div>
      </div>
    </div>
  </div>
  <!-- FOOTER -->
