...
<meta name="description" content="Download Modem <?php echo $row['Companny']; ?> <?php echo $row['Model_Name']; ?> <?php echo $row['Model']; ?> الحماية :<?php echo $row['Protect']; ?> ">
<meta name="keywords" content=" modem <?php echo $row['Model']; ?>,modem <?php echo $row['Model_Name']; ?>,modem <?php echo $row['Model']; ?> modem <?php echo $row['Model_Name']; ?>,حل مشكلة null imei <?php echo $row['Model']; ?>,حل مشكلة مكالمات الطوارئ <?php echo $row['Model']; ?>,حل مشكلة شبكة <?php echo $row['Model']; ?>,reset msl <?php echo $row['Model']; ?>,write cert <?php echo $row['Model']; ?>, fix null imei <?php echo $row['Model']; ?>, repeire imei <?php echo $row['Model']; ?>">
<title>Download Modem <?php echo $row['Model_Name']; ?> ~ <?php echo $row['Model']; ?> <?php echo $row['Protect']; ?> </title>
...
></span> LANGUAGE <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li class="arabic">  <a  href="../../AR/Samsung/Download_Modem.php?MOid=<?php echo $row['MOid']; ?>">العربية</a></li>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12  col-xs-12">
          ...
          <div class="col-lg-8 col-md-8 col-sm-8  col-xs-12">
            <div class="all-device">
              <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" >DOWNLOAD MODEM  <?php echo $row['Model_Name']; ?> <?php echo $row['Model']; ?>  </h4>
            </div>
            <div class="info-device"> <br>
              <li>
                <h4> <p class="type"> <span class="glyphicon glyphicon-hand-right"> </span>   TYPE FILE : </p> <?php echo $row['type']; ?> .</h4>
              </li>
              <br>
              <li>
                <h4> <p class="type"> <span class="glyphicon glyphicon-hand-right"> </span>   COMPANY : </p> SAMSUNG  .</h4>
              </li>
              <br>
              <li>
              ...
              <br>
               <li>
                <h4> <p class="type"> <span class="glyphicon glyphicon-hand-right"> </span>  <?php if($row['Besband'] == "0"){ echo "PROTECT";} else { echo "BASEBAND"; }?> :</p> <?php if($row['Besband'] == "0"){ echo $row['Protect'];} else { echo $row['Besband']; }?> .</h4>
              </li>
              <br>
               <?php if($row['Version'] != ''){  ?>
              <li>
