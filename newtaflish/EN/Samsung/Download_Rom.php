...
$stmt = $connect->prepare(" SELECT * FROM offecial WHERE `Oid` = ?");
...
$view = $roms['view'] +1;
$stmt = $connect->prepare("UPDATE offecial SET view= ?  WHERE `Oid` = ?");
...
<html lang="en">
<head>
<title>Download Official [STOCK] ROM  FOR <?php echo $roms['Model_Name']; ?> - <?php echo $roms['Modell']; ?> V: <?php echo $roms['Vrsion']; ?>  <?php echo $roms['Besband']; ?> <?php echo $roms['Languages']; ?></title>

<meta name="description" content="Download Official ROM FOR <?php echo $roms['Model_Name']; ?> , <?php echo $roms['Modell']; ?> <?php echo $roms['Vrsion']; ?>  <?php echo $roms['Besband']; ?> <?php echo $roms['Languages']; ?>">
<meta name="keywords" content="download rom samsung <?php echo $roms['Model_Name']; ?>,samsung <?php echo $roms['Model_Name']; ?> rom download,روم <?php echo $roms['Model_Name']; ?>, روم <?php echo $roms['Modell']; ?>, روم عربي <?php echo $roms['Modell']; ?>, روم معرب <?php echo $roms['Modell']; ?>, روم رسمي <?php echo $roms['Modell']; ?>, تعريب <?php echo $roms['Modell']; ?>,rom <?php echo $roms['Modell']; ?>,rom <?php echo $roms['Model_Name']; ?>,rom arabic <?php echo $roms['Modell']; ?>, full rom <?php echo $roms['Modell']; ?>,تعريب <?php echo $roms['Model_Name']; ?>">
...
></span> LANGUAGE <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li class="arabic"> <a  href="../../AR/Samsung/Download_Rom.php?Oid=<?php echo $roms['Oid']; ?>">العربية</a></li>
              <li role="separator" class="divider"></li>
              <li><a href="Download_Rom.php?Oid=<?php echo $roms['Oid']; ?>">English</a></li>
            </ul>
          </li>
        </ul>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12  col-xs-12">
          ...
          <div class="col-lg-8 col-md-8 col-sm-8  col-xs-12">
            <div class="all-device">
              <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" >DOWNLOAD OFFICIAL ROM FOR <?php echo $roms['Companny']; ?> - <?php echo $roms['Modell']; ?> </h4>
            </div>
            <div class="info-device"> <br>
              <li>
                <h4> <p class="type"> <span class="glyphicon glyphicon-hand-right"> </span>   TYPE FILE : </p>  STOCK ROM .</h4>
              </li>
              <br>
              <li>
                <h4> <p class="type"> <span class="glyphicon glyphicon-hand-right"> </span>   COMPANY : </p> <?php echo $roms['Companny']; ?>  .</h4>
              </li>
              <br>
              <li>
                <h4> <p class="type"> <span class="glyphicon glyphicon-hand-right"> </span>    DEVICE NAME : </p> <?php echo $roms['Model_Name']; ?> .</h4>
              </li>
              <br>
              <li>
                <h4> <p class="type"> <span class="glyphicon glyphicon-hand-right"> </span>    MODEL : </p> <?php echo $roms['Modell']; ?> .</h4>
              </li>
              <br>
               <li>
                <h4> <p class="type"> <span class="glyphicon glyphicon-hand-right"> </span>    BASEBAND : </p> <?php echo $roms['Besband']; ?> .</h4>
              </li>
              <br>
               <li>
               <h4> <p class="type"> <span class="glyphicon glyphicon-hand-right"> </span>    VERSION : </p> <?php echo $roms['Vrsion']; ?> .</h4>
              </li>
              <br>
               <li>
                <h4> <p class="type"> <span class="glyphicon glyphicon-hand-right"> </span>    COUNTRY : </p> <?php echo $roms['Languages']; ?> .</h4>
              </li>
              <br>
              <li>
                <h4> <p class="type"> <span class="glyphicon glyphicon-hand-right"> </span>    INFO : </p> <?php echo $roms['About']; ?> .</h4>
              </li>
              <br>
               <li>
                <h4> <p class="type"> <span class="glyphicon glyphicon-hand-right"> </span>    VIEWS : </p> <?php echo $roms['view']; ?> .</h4>
              </li>
              <br>
              ...
              <br>
              <li> <a   class="link-download" href="<?php echo $roms['Link1']; ?>"><span class="glyphicon glyphicon-circle-arrow-down"> </span> DOWNLOAD <span class="glyphicon glyphicon-circle-arrow-down
"> </span></a></li>
              <br>
              <div class="ads-download">
              <?php echo $ads['ads_d2']; ?>
