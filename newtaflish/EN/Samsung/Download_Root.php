...
<meta name="description" content="Download Root And Recovery For <?php echo $row['Model_Name']; ?> <?php echo $row['Model']; ?> <?php echo $row['Version']; ?> <?php echo $row['Mod_Root']; ?>">
...
<title>Download Root And Recovery For <?php echo $row['Model_Name']; ?> <?php echo $row['Model']; ?> <?php echo $row['Version']; ?> <?php echo $row['Mod_Root']; ?> </title>
...
></span> LANGUAGE <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li class="arabic">  <a  href="../../AR/Samsung/Download_Root.php?ROid=<?php echo $row['ROid']; ?>">العربية</a></li>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12  col-xs-12">
          ...
          <div class="col-lg-8 col-md-8 col-sm-8  col-xs-12">
            <div class="all-device">
              <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" >DOWNLOAD ROOT AND RECOVERY FOR <?php echo $row['Companny']; ?>  <?php echo $row['Model']; ?> </h4>
            </div>
            <div class="info-device"> <br>
              <li>
                <h4> <p class="type"> <span class="glyphicon glyphicon-hand-right"> </span>   TYPE FILE : </p>  ROOT AND RECOVERY .</h4>
              </li>
              <br>
              <li>
              ...
              <br>
               <li>
                <h4> <p class="type"> <span class="glyphicon glyphicon-hand-right"> </span>   ROOT METHODE : </p> <?php echo $row['Mod_Root']; ?> .</h4>
              </li>
              <br>
               <li>
              ...
              <?php if($row['Link2'] !='' ){ ?>
               <li>
               <h4> <p class="type"> <span class="glyphicon glyphicon-hand-right"> </span>  PROTECT  : </p> <?php echo $row['Link2']; ?> .</h4>
              </li>
              <br>
              <?php } ?>
