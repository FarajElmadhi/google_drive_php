...
<meta name="description" content="Download Modem Files For Samsung For Fix Null IMEI AND Repaire Network">
<meta name="keywords" content=" modem,download modem,fix not registered on network,repaire imei null,modem samsung">
<title>Modem For Samsung  </title>
...
></span> LANGUAGE <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li class="arabic"> <a  href="../../AR/Samsung/Modem.php">العربية</a></li>
    ...
    <div class="row">
      <div class="col-xs-12 visible-xs">
        <div class="all-device-mobile">
          <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" >MODEM FILES FOR SAMSUNG</h4>
        </div>
        <?php  foreach($roms as $row){ ?>
          <div class="mobile-table btn-block text-center "> 
          <a href="View_Modem.php?Model=<?php echo $row['Model']; ?>">
          <div class="file-type "> MODEM <p><pr> <span class="glyphicon glyphicon glyphicon-eye-open">
          </span> <?php echo $row['view']; ?></p></div> <?php echo $row['Model_Name']; ?> - <?php echo $row['Model']; ?> </a></div>
          <?php }  ?>
      </div>
    </div>
    <div>
              ...
              <tbody>
                <?php  foreach($roms as $row){ ?>
                  <tr>
                    ...
                    <td><a class="link-main" href="View_Modem.php?Model=<?php echo $row['Model']; ?>" >VIEW <span class="fa fa-chevron-right"> </span></a></td>
                  </tr>
                  <?php }  ?>
              </tbody>
            </table>
