...
<title>FREE CERT FILE FOR <?php echo $row['company']; ?> <?php echo $row['model_name']; ?> <?php echo $row['model']; ?> </title>
...
></span> LANGUAGE <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li class="arabic"> <a  href="../../AR/Samsung/View-Cert-Samsung.php?model=<?php echo $row['model']; ?>">العربية</a></li>
    ...
    <div class="row">
      <div class="col-xs-12 visible-xs">
        <div class="all-device-mobile">
          <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" >DOWNLOAD CERT FILES FOR  <?php echo $row['company']; ?>  <?php echo $row['model']; ?></h4>
        </div>
   <?php  foreach($roms as $row){ ?>

       <div class="mobile-table btn-block text-center "> <a href="Download-Cert.php?ceid=<?php echo $row['ceid']; ?>"><div class="file-type "> CERT <p><pr> <span class="glyphicon glyphicon glyphicon-eye-open"></span> <?php echo $row['view']; ?></p></div>  <?php echo $row['model_name']; ?> - <?php echo $row['model']; ?>  - <?php echo $row['key_id']; ?> <br>IMEI : <?php echo $row['imei']; ?> </a></div>
                          <?php }     ?>
              ...
              <tbody>
                ...
                <?php  foreach($roms as $row){ ?>
                  <tr>
                    ...
                    <td><a class="link-main" href="Download-Cert.php?ceid=<?php echo $row['ceid']; ?>" >VIEW <span class="fa fa-chevron-right"> </span></a></td>
                  </tr>
                  <?php }   ?>
              </tbody>
            </table>
