...
<meta name="description" content=" Download Modem <?php echo $row['Companny']; ?> <?php echo $row['Model_Name']; ?> <?php echo $row['Model']; ?> All version and all protect and baseband">
<meta name="keywords" content=" modem <?php echo $row['Model']; ?>,modem <?php echo $row['Model_Name']; ?>,modem <?php echo $row['Model']; ?> modem <?php echo $row['Model_Name']; ?>,حل مشكلة null imei <?php echo $row['Model']; ?>,حل مشكلة مكالمات الطوارئ <?php echo $row['Model']; ?>,حل مشبكلة شبكة <?php echo $row['Model']; ?>,reset msl <?php echo $row['Model']; ?>,write cert <?php echo $row['Model']; ?>, fix null imei <?php echo $row['Model']; ?>, repeire imei <?php echo $row['Model']; ?>">
<title> MODEM <?php echo $row['Model_Name']; ?> <?php echo $row['Model']; ?></title>
...
></span> LANGUAGE <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li class="arabic"><a  href="../../AR/Samsung/View_Modem.php?Model=<?php echo $row['Model']; ?>">العربية</a></li>
    ...
    <div class="row">
      <div class="col-xs-12 visible-xs">
        <div class="all-device-mobile">
          <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" > MODEM <?php echo $row['Model_Name']; ?> - <?php echo $row['Model']; ?> </h4>
        </div>
   <?php  foreach($roms as $row){ ?>

       <div class="mobile-table btn-block text-center "> <a href="Download_Modem.php?MOid=<?php echo $row['MOid']; ?>"><div class="file-type "> <?php echo $row['type']; ?> <p><pr> <span class="glyphicon glyphicon glyphicon-eye-open"></span> <?php echo $row['view']; ?></p></div> <?php echo $row['Model_Name']; ?>   - <?php if($row['Besband'] == "0"){ echo $row['Protect'];} else { echo $row['Besband']; }?> - <?php echo $row['Version']; ?> </a></div>
                          <?php }     ?>
              ...
              <tbody>
                ...
                <?php  foreach($roms as $row){ ?>
                  <tr>
                    ...
                    <td><a class="link-main" href="Download_Modem.php?MOid=<?php echo $row['MOid']; ?>" >VIEW <span class="fa fa-chevron-right"> </span></a></td>
                  </tr>
                  <?php }   ?>
              </tbody>
            </table>
