...
></span> LANGUAGE <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li class="arabic"><a  href="../../AR/Samsung/View_Root.php?Model=<?php echo $row['Model']; ?>">العربية</a></li>
              <li role="separator" class="divider"></li>
              <li><a href="View_Root.php?Model=<?php echo $row['Model']; ?>">English</a></li>
            </ul>
          </li>
        </ul>
    ...
    <div class="row">
      <div class="col-xs-12 visible-xs">
        <div class="all-device-mobile">
          <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" >ROOT AND RECOVERY FOR <?php echo $row['Companny']; ?> <?php echo $row['Model']; ?></h4>
        </div>
   <?php  foreach($roms as $row){ ?>

       <div class="mobile-table btn-block text-center "> <a href="Download_Root.php?ROid=<?php echo $row['ROid']; ?>"><div class="file-type "> ROOT <p><pr> <span class="glyphicon glyphicon glyphicon-eye-open"></span> <?php echo $row['view']; ?></p></div>  <?php echo $row['Model_Name']; ?>   - <?php echo $row['Mod_Root']; ?>  -   ( <?php echo $row['Version']; ?> ) </a></div>
                          <?php }     ?>
            ...
            <table class="table text-capitalize">
              <thead>
                <tr>
                  ...
                  <th><h4>MODEL</h4></th>
                  <th><h4>VERSION / PROTECT </h4></th>
                                    <th><h4>ROOT METHOD</h4></th>
              ...
              <tbody>
                ...
                <?php  foreach($roms as $row){ ?>
                  <tr>
                    ...
                    <td><h4><?php echo $row['Companny']; ?>  ( ROOT ) </h4></td>
                    <td><h4><?php echo $row['Model_Name']; ?></h4></td>
                    <td><h4><?php echo $row['Model']; ?></h4></td>
                     <td><h4><?php echo $row['Version']; ?><?php if($row['Link2'] !=''){ echo " / " . $row['Link2']; } ?> </h4></td>
                                          <td><h4> <?php echo $row['Mod_Root']; ?> </h4></td>


                    <td><a class="link-main" href="Download_Root.php?ROid=<?php echo $row['ROid']; ?>" >VIEW <span class="fa fa-chevron-right"> </span></a></td>
                  </tr>
                  <?php }   ?>
              </tbody>
            </table>
