...
<meta name="description" content="Download lock remove pattern  <?php echo $row['Model_Name']; ?>  <?php echo $row['Model']; ?> <?php echo $row['Besband']; ?>">
...
<title>DOWNLOAD LOCK REMOVE PATTERN   <?php echo $row['Model_Name']; ?> <?php echo $row['Model']; ?></title>
...
></span> LANGUAGE <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li class="arabic"> <a  href="../../AR/Sony/Download_Lock_Remove.php?LRid=<?php echo $row['LRid']; ?>">العربية</a></li>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12  col-xs-12">
          ...
          <div class="col-lg-8 col-md-8 col-sm-8  col-xs-12">
            <div class="all-device">
              <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" >DOWNLOAD LOCK REMOVE PATTERN FTF FOR <?php echo $row['Model_Name']; ?>  <?php echo $row['Model']; ?>  </h4>
            </div>
            <div class="info-device"> <br>
              <li>
                <h4> <p class="type"> <span class="glyphicon glyphicon-hand-right"> </span>   TYPE FILE : </p>  LOCK REMOVE FTF .</h4>
              </li>
              <br>
              <li>
                <h4> <p class="type"> <span class="glyphicon glyphicon-hand-right"> </span>   COMPANY : </p>  SONY  .</h4>
              </li>
              <br>
              <li>
