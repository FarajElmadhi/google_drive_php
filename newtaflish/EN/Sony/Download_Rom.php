...
<meta name="description" content="Download rom <?php echo $row['Model_Name']; ?>  <?php echo $row['Model']; ?>  <?php echo $row['Version']; ?>  <?php echo $row['Besband']; ?>">
...
<title>DOWNLOAD ROM <?php echo $row['Companny']; ?> <?php echo $row['Model_Name']; ?> <?php echo $row['Model']; ?> <?php echo $row['Version']; ?>  <?php echo $row['Besband']; ?></title>
...
></span> LANGUAGE <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li class="arabic"> <a  href="../../AR/Sony/Download_Rom.php?SOid=<?php echo $row['SOid']; ?>">العربية</a></li>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12  col-xs-12">
          ...
          <div class="col-lg-8 col-md-8 col-sm-8  col-xs-12">
            <div class="all-device">
              <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" >DOWNLOAD ROM <?php echo $row['Companny']; ?>  <?php echo $row['Model']; ?> </h4>
            </div>
