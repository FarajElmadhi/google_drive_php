...
<meta name="description" content="Download  lock remove ftf for samsung xperia for bypasse pattern without full flashing">
<meta name="keywords" content="lock remove ftf sony,bypasse pattern xperia,remove pattern sony xperia,remove pin sony,format sony xperia,hard reset sony xperia,lock remove ftf sony xperia,bypasse lock screen sony xperia,download rom xperia,download recovery sony xperia,download remove pattern sony xperia">
<title>LOCK REMOVE FTF FOR SONY XPERIA</title>
...
></span> LANGUAGE <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li class="arabic"><a  href="../../AR/Sony/Lock_Remove.php">العربية</a></li>
    ...
    <div class="row">
      <div class="col-xs-12 visible-xs">
        <div class="all-device-mobile">
          <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" >LOCK REMOVE FTF FOR SONY XPERIA</h4>
        </div>
        <?php  foreach($roms as $row){ ?>
          <div class="mobile-table btn-block text-center "> <a href="View_Lock_Remove.php?Model=<?php echo $row['Model']; ?>"> <div class="file-type ">LOCK REMOVE<p><pr> <span class="glyphicon glyphicon glyphicon-eye-open"></span> <?php echo $row['view']; ?></p></div> <?php echo $row['Model_Name']; ?> - <?php echo $row['Model']; ?> </a></div>
          <?php }   ?>
      </div>
    </div>
    <div>
              ...
              <tbody>
                <?php  foreach($roms as $row){ ?>
                  <tr>
                    ...
                    <td><h4><?php echo $row['Companny']; ?>  ( LOCK REMOVE FTF ) </h4></td>
                    <td><h4><?php echo $row['Model_Name']; ?></h4></td>
                    <td><h4><?php echo $row['Model']; ?></h4></td>
                    <td><a class="link-main" href="View_Lock_Remove.php?Model=<?php echo $row['Model']; ?>" >VIEW <span class="fa fa-chevron-right"> </span></a></td>
                  </tr>
                  <?php }    ?>
              </tbody>
            </table>
