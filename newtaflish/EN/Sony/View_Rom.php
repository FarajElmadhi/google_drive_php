...
<meta name="description" content="Download official rom  <?php echo $row['Model_Name']; ?>  <?php echo $row['Model']; ?> All Version">
<meta name="keywords" content=" rom <?php echo $row['Model_Name']; ?>, rom <?php echo $row['Model']; ?>, firmware <?php echo $row['Model']; ?>,firmware <?php echo $row['Modell']; ?>,official rom <?php echo $row['Model']; ?>,official firmware <?php echo $row['Modell']; ?>,rom <?php echo $row['Model']; ?>,rom <?php echo $row['Model_Name']; ?>,rom arabic <?php echo $row['Modell']; ?>, full rom <?php echo $row['Model']; ?>,repaire <?php echo $row['Model_Name']; ?>,fix <?php echo $row['Model_Name']; ?>">
<title> ROM <?php echo $row['Model_Name']; ?> ~ <?php echo $row['Model']; ?> </title>
...
></span> LANGUAGE <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li class="arabic"><a  href="../../AR/Sony/View_Rom.php?Model=<?php echo $row['Model']; ?>">العربية</a></li>
    ...
    <div class="row">
      <div class="col-xs-12 visible-xs">
        <div class="all-device-mobile">
          <h4 class="wow flash" data-wow-duration="4s" data-wow-iteration="100" >STOCK ROM  <?php echo $row['Companny']; ?>  <?php echo $row['Model']; ?></h4>
        </div>
   <?php  foreach($roms as $row){ ?>

       <div class="mobile-table btn-block text-center "> <a href="Download_Rom.php?SOid=<?php echo $row['SOid']; ?>">  <div class="file-type ">STOCK ROM <p><pr> <span class="glyphicon glyphicon glyphicon-eye-open"></span> <?php echo $row['view']; ?></p></div> <?php echo $row['Model_Name']; ?>   - <?php echo $row['Besband']; ?>  -   ( <?php echo $row['Version']; ?> ) </a></div>
                          <?php }     ?>
              ...
              <tbody>
                ...
                <?php  foreach($roms as $row){ ?>
                  <tr>
                    ...
                    <td><a class="link-main" href="Download_Rom.php?SOid=<?php echo $row['SOid']; ?>">VIEW <span class="fa fa-chevron-right"> </span></a></td>
                  </tr>
                  <?php }   ?>
              </tbody>
            </table>
